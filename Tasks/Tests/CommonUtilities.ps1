function Connect-FabricService {
	...
	$authScheme = $FabricConnection.Auth.Scheme
	$authParams = $FabricConnection.Auth.Parameters
	$environment = $FabricConnection.Data.Environment

	Write-Host "Connecting to Fabric with $authScheme"
